...
export const SlideTransition = ({
  ...
  const blurDirection = direction === "left" || direction === "right" ? "X" : "Y";
  ...
  const rotation = rotate
    ? (1 - animProgress) * rotateAmount * (direction === "right" || direction === "down" ? -1 : 1)
    : 0;
  ...
  const contentStyle: CSSProperties = {
    ...
    filter: blur > 0.5 
      ...
      : undefined,
    opacity,
    boxShadow: shadow && shadowOpacity > 0.01
            ...
            <div
              ...
              style={{
                ...
                transform: `
                  ...
                  rotate${rotationAxis}(${rotation}deg)
                `,
                opacity: i === Math.floor(layers / 2) ? opacity : layerOpacity * opacity * 0.3,
