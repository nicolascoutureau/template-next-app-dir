...
import { Shimmer, ShimmerText } from "../../remotion/base/components/effects";
...
export const CardSkeleton: Story = {
  render: () => (
    ...
    >
      <Shimmer width={260} height={150} style={{ borderRadius: 8, marginBottom: 16 }} />
...
export const DarkMode: Story = {
  ...
  render: () => (
    <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
      <Shimmer width={250} height={16} baseColor="#2a2a4e" highlightColor="#3a3a6e" />
      <Shimmer width={200} height={16} baseColor="#2a2a4e" highlightColor="#3a3a6e" />
      <Shimmer width={280} height={16} baseColor="#2a2a4e" highlightColor="#3a3a6e" />
    </div>
  ),
};
